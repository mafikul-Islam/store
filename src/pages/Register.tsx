...
import { registerUser, loginWithGoogle } from '../lib/store';
            ...
            <main className="flex-1 flex flex-col justify-center py-12 px-4 sm:px-6 lg:px-8">
                <div className="sm:mx-auto sm:w-full sm:max-w-md">
                    ...
                    <p className="mt-2 text-center text-sm text-gray-500 dark:text-gray-400">
                        Already have an account? <Link to="/admin/login" className="font-semibold leading-6 text-black dark:text-white hover:text-gray-700 dark:hover:text-gray-300">Sign in</Link>
                    </p>
                </div>
