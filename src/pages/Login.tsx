...
import { login, isAdmin } from '../lib/store';
            ...
            <main className="flex-1 flex flex-col justify-center py-12 px-4 sm:px-6 lg:px-8">
                <div className="sm:mx-auto sm:w-full sm:max-w-md">
                    ...
                    <p className="mt-2 text-center text-sm text-gray-500 dark:text-gray-400">
                        Or <Link to="/register" className="font-semibold leading-6 text-indigo-600 dark:text-indigo-400 hover:text-indigo-500 dark:hover:text-indigo-300 underline">create a new account</Link>
                    </p>
                </div>
