...
<head>
 ...
 <title>Login - Mafikul's Store</title>
...
<div class="fixed inset-0 -z-50 overflow-hidden pointer-events-none transition-colors duration-300">
 ...
 <a href="login.php" class="flex items-center gap-2 text-sm font-medium text-black dark:text-white transition-colors">
 ...
 <i data-feather="lock" class="h-6 w-6 text-white dark:text-black"></i>
 </div>
 <h2 class="mt-6 text-center text-2xl font-bold leading-9 tracking-tight text-gray-900 dark:text-white">
 Sign in to your account
 </h2>
 <p class="mt-2 text-center text-sm text-gray-500 dark:text-gray-400">
 Or <a href="register.php" class="font-semibold leading-6 text-indigo-600 hover:text-indigo-500 underline">create a new account</a>
 </p>
 </div>
 ...
 <div>
 <label for="loginId" class="block text-sm font-medium leading-6 text-gray-900 dark:text-white">
 Email or Username
 </label>
